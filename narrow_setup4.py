...
# train.py
cmd = "python -m torch.distributed.launch --nproc_per_node=1 --master_port=29447  \
       ~/stereo_sr/train.py \
       -opt ./options/train_modem_scam_s.yml"

# test.py
cmd1 = "python -m torch.distributed.launch --nproc_per_node=1 --master_port=29448  \
        ~/stereo_sr/test.py \
        -opt ./options/test_modem_scam_s.yml"
