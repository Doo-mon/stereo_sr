...
# train.py
cmd = "python -m torch.distributed.launch --nproc_per_node=1 --master_port=29445  \
       ~/stereo_sr/train.py \
       -opt ./options/train_modem_rcsb_t.yml"

# test.py
cmd1 = "python -m torch.distributed.launch --nproc_per_node=1 --master_port=29446  \
        ~/stereo_sr/test.py \
        -opt ./options/test_modem_rcsb_t.yml"
