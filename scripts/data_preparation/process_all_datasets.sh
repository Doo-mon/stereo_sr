...
# 验证集处理
python val_test_data_process.py --dataset_name Flickr1024 --data_type Validation

# 测试集处理
python val_test_data_process.py --dataset_name Flickr1024 --data_type Test 
...
# 5个测试集处理
python val_test_data_process.py --dataset_name Middlebury_test --data_type Test 
...
python val_test_data_process.py --dataset_name Middlebury2021 --data_type Test 
